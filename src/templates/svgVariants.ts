...
const WIND_SWEPT_OUTLINE: FracCmd[] = [
  ...
  [1, 0.5309, 0.9989],
  // Bottom edge — sweeping left
  [3, 0.4800, 0.9970, 0.4200, 0.9950, 0.3500, 0.9900],
  [3, 0.2900, 0.9760, 0.2200, 0.9600, 0.1700, 0.9450],
  [3, 0.1350, 0.9370, 0.0660, 0.9140, 0.0550, 0.9084],
  [3, 0.0400, 0.9040, 0.0030, 0.8900, 0.0034, 0.8681],
  // Left side — up through the body
  [3, 0.0070, 0.8480, 0.0290, 0.7860, 0.0420, 0.7600],
  [3, 0.0560, 0.7270, 0.0880, 0.6700, 0.0980, 0.6590],
  [3, 0.1100, 0.6400, 0.1270, 0.6110, 0.1320, 0.6035],
  [3, 0.1500, 0.5600, 0.1660, 0.5230, 0.1690, 0.5110],
  [3, 0.1730, 0.4990, 0.1740, 0.4900, 0.1820, 0.4560],
  // Left side — shoulder area
  [3, 0.1880, 0.4000, 0.1850, 0.3000, 0.1800, 0.2450],
  [3, 0.1785, 0.2060, 0.1840, 0.1840, 0.2040, 0.1470],
  [3, 0.2120, 0.1320, 0.2190, 0.1200, 0.2280, 0.1105],
  // Neckline — going right
  [3, 0.2400, 0.0960, 0.2630, 0.0770, 0.2760, 0.0680],
  [3, 0.3050, 0.0440, 0.3530, 0.0190, 0.3910, 0.0021],
  [3, 0.4200, -0.0050, 0.4680, 0.0000, 0.5080, 0.0180],
  // Right shoulder — swept side
  [3, 0.5360, 0.0350, 0.5510, 0.0550, 0.5600, 0.0900],
  [3, 0.5650, 0.1100, 0.5670, 0.1200, 0.5700, 0.1600],
  // Right side — the swept flowing edge
  [2, 0.5555, 0.1724],
  [3, 0.5350, 0.1890, 0.5000, 0.2160, 0.4510, 0.2800],
  [3, 0.4380, 0.3000, 0.4230, 0.3200, 0.4190, 0.3280],
  [3, 0.4060, 0.3530, 0.4040, 0.3910, 0.4330, 0.4050],
  [3, 0.4530, 0.4050, 0.4650, 0.3750, 0.4600, 0.3510],
  [3, 0.4520, 0.3310, 0.4680, 0.2860, 0.4980, 0.2480],
  [3, 0.5120, 0.2320, 0.5540, 0.2000, 0.5700, 0.1955],
  [3, 0.6020, 0.1910, 0.6350, 0.1980, 0.6860, 0.2180],
  [3, 0.7300, 0.2520, 0.7670, 0.2930, 0.7940, 0.3620],
  // Right side — lower body
  [3, 0.7980, 0.3770, 0.8050, 0.3990, 0.8070, 0.4090],
  [3, 0.8140, 0.4380, 0.8220, 0.4670, 0.8290, 0.4960],
  [3, 0.8360, 0.5250, 0.8400, 0.5420, 0.8440, 0.5620],
  [3, 0.8510, 0.5880, 0.8600, 0.6070, 0.8730, 0.6340],
  [3, 0.8820, 0.6560, 0.8940, 0.6850, 0.9080, 0.7190],
  [3, 0.9200, 0.7460, 0.9300, 0.7680, 0.9400, 0.7930],
  [3, 0.9700, 0.8580, 0.9760, 0.8650, 0.9880, 0.8870],
  // Bottom-right return
  [2, 1.0000, 0.9039],
  [2, 0.9943, 0.9076],
  [3, 0.9750, 0.9200, 0.9130, 0.9430, 0.8650, 0.9550],
  [3, 0.8340, 0.9630, 0.7910, 0.9730, 0.7550, 0.9780],
  [3, 0.7000, 0.9870, 0.6400, 0.9950, 0.5309, 0.9989],
  [0],
];
...
export class CapeSevenPoints extends Template {
  ...
  generateCutPaths(params: TemplateParams): string[] {
    ...
    // Cut line from top center V to top of center circle
    const slit = new SVGPath();
    slit.moveTo(width * 0.5063, length * 0.1084);
    slit.lineTo(width * 0.5046, length * 0.2805);
    paths.push(slit.toString());
    // Attachment holes (5.3mm standard)
